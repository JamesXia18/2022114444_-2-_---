namespace Leveling
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            从数据库导出ToolStripMenuItem = new ToolStripMenuItem();
            ...
            in1文件导入数据库ToolStripMenuItem = new ToolStripMenuItem();
            ...
            // 文件ToolStripMenuItem
            // 
            文件ToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { 打开水准观测文件ToolStripMenuItem, 从数据库导出ToolStripMenuItem });
            ...
            // 
            // 从数据库导出ToolStripMenuItem
            // 
            从数据库导出ToolStripMenuItem.Name = "从数据库导出ToolStripMenuItem";
            从数据库导出ToolStripMenuItem.Size = new Size(212, 26);
            从数据库导出ToolStripMenuItem.Text = "导出平差报告";
            从数据库导出ToolStripMenuItem.Click += 从数据库导出ToolStripMenuItem_Click;
            // 
            ...
            label4.Location = new Point(492, 146);
            label4.Name = "label4";
            ...
            // button4
            // 
            button4.Location = new Point(699, 89);
            ...
            // button1
            // 
            button1.Location = new Point(492, 267);
            ...
            label3.Location = new Point(183, 191);
            label3.Name = "label3";
            ...
            // richTextBox3
            // 
            richTextBox3.Location = new Point(492, 169);
            ...
            comboBox1.Location = new Point(543, 33);
        ...
        private ToolStripMenuItem 从数据库导出ToolStripMenuItem;
        private ToolStripMenuItem in1文件导入数据库ToolStripMenuItem;
    }
}
